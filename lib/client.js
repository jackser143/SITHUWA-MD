...
try {
    ...
    console.log("📡 Connected to the SYAM~SER DB")
} catch {
...
let cc = Config.sessionName.replace(/SITHUWA-MD;;;/gi, ""); // Dont Remove "SITHUWA-MD;;;" So that You Can Use Secktor Qr too in your bot
...
setTimeout(() => {
    ...
    async function syncdb() {
        ...
        const ChangePic = __dirname + "/assets/sithuwa.png"
        await writeFile(ChangePic, thumbbuffer);
        global.log0 = fs.readFileSync(__dirname + "/assets/sithuwa.png"); //ur logo pic
        ...
        if (icmd) {
            ...
            if (Config.voice==="true") {
		     ...
		     case 'Gm': {
                        ...
                        const viourl = 'https://github.com/Sithuwa/SITHUWA-MD/raw/main/media'+body+'.mp3';
		        ...
		        let devss = ['94761516805']    // put developers Contacts in this array, MAKE SURE ALL OF THESE IN ARRAY FORMATE
                if (citel.chat === "120363176073239014@g.us" && citel.sender!=='94761516805@s.whatsapp.net') return //PUT GROUP JIDS HERE, SO THAT BOT NOT ALLOW IN THESE GROUPS
